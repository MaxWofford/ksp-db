...
class CraftsControllerTest < ActionController::TestCase
  ...
  test "should create craft" do
    assert_difference('Craft.count') do
      post :create, craft: { craft_file: @craft.craft_file, description: @craft.description, name: @craft.name }
    end
  ...
  test "should update craft" do
    patch :update, id: @craft, craft: { craft_file: @craft.craft_file, description: @craft.description, name: @craft.name }
    assert_redirected_to craft_path(assigns(:craft))
  end
